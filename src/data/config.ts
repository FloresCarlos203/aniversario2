...
export const PAREJA = {
  el: 'Carlos',
  ella: 'Mi Amor', // 👈 pon aquí el nombre de ella
}
...
export const CANCIONES: Cancion[] = [
  {
    ...
    titulo: 'Canción del día 1',
    artista: 'Artista 1',
    dedicatoria:
      'Esta canción me recuerda al día en que te conocí. Desde entonces, todo cambió para bien. 💜',
    audio: '/music/dia1.mp3',
    portada: '/covers/portada1.jpg',
  },
  {
    dia: 2,
    desbloqueo: '2026-07-14',
    titulo: 'Canción del día 2',
    artista: 'Artista 2',
    dedicatoria:
      'Cada vez que la escucho pienso en tu sonrisa, la que ilumina hasta mis días más grises. 🌷',
    audio: '/music/dia2.mp3',
    portada: '/covers/portada2.jpg',
  },
  {
    dia: 3,
    desbloqueo: '2026-07-15',
    titulo: 'Canción del día 3',
    artista: 'Artista 3',
    dedicatoria:
      'Esta es de esas canciones que gritan lo que siento: contigo todo es mejor. 💚',
    audio: '/music/dia3.mp3',
    portada: '/covers/portada3.jpg',
  },
  {
    dia: 4,
    desbloqueo: '2026-07-16',
    titulo: 'Canción del día 4',
    artista: 'Artista 4',
    dedicatoria:
      'Para bailarla juntos, aunque sea en la sala de la casa, descalzos y muertos de risa. 💃',
  ...
  },
  {
    ...
    titulo: 'Canción del día 5',
    artista: 'Artista 5',
    dedicatoria:
      'Me haces sentir en casa. Esta canción es ese abrazo tuyo que me calma todo. 🩷',
    audio: '/music/dia5.mp3',
    portada: '/covers/portada5.jpg',
  },
  {
    dia: 6,
    desbloqueo: '2026-07-18',
    titulo: 'Canción del día 6',
    artista: 'Artista 6',
    dedicatoria:
      'Un día antes de nuestro aniversario: gracias por elegirme cada día, como yo te elijo a ti. ❤️',
    audio: '/music/dia6.mp3',
  ...
  },
  {
    ...
    artista: 'La más especial',
    dedicatoria:
      '¡Feliz aniversario, mi amor! Dos años contigo y quiero mil más. Esta canción es nuestra, hoy y siempre. 💜💍',
...
export function fechaAniversario(): Date {
  return new Date(ANIVERSARIO.anio, ANIVERSARIO.mes - 1, ANIVERSARIO.dia, 0, 0, 0)
}
