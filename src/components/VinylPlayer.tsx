      ...
      <div className="player player-vacio">
        ...
        <div className="player-info">
          ...
          <p className="player-dedicatoria">
            La primera canción se desbloquea muy pronto. Mañana la podrás
            escuchar. Mientras tanto disfruta de la galería de recuerdos y la
            mini carta que te escribí. ¡Te amo!❤️
          </p>
        </div>
      </div>
    );
      ...
      <div className="vinyl-wrap">
        <div className={`vinyl ${playing ? "girando" : ""}`}>
          ...
          <div className="vinyl-label">
            {falloPortada ? (
              <div
                className={`portada-fallback fb-${((cancion.dia - 1) % 4) + 1}`}
              >
                <span className="fb-nota">♪</span>
              </div>
            ) : (
